================================================================================
    MICROSOFT FOUNDATION CLASS LIBRARY : LotroBoxer Project Overview
===============================================================================

The application wizard has created this LotroBoxer application for
you.  This application not only demonstrates the basics of using the Microsoft
Foundation Classes but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your LotroBoxer application.
...
LotroBoxer.h
    ...
    CLotroBoxerApp application class.

LotroBoxer.cpp
    This is the main application source file that contains the application
    class CLotroBoxerApp.
...
res\LotroBoxer.ico
    ...
    icon is included by the main resource file LotroBoxer.rc.
...
LotroBoxerDlg.h, LotroBoxerDlg.cpp - the dialog
    These files contain your CLotroBoxerDlg class.  This class defines
    the behavior of your application's main dialog.  The dialog's template is
    in LotroBoxer.rc, which can be edited in Microsoft Visual C++.

DlgProxy.h, DlgProxy.cpp - the automation object
    These files contain your CLotroBoxerDlgAutoProxy class.  This class
...
StdAfx.h, StdAfx.cpp
    ...
    named LotroBoxer.pch and a precompiled types file named StdAfx.obj.
